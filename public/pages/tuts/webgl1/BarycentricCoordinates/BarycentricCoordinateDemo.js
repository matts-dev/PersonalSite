...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'Applications/BarycentricCoordinates/BarycentricCoordinateDemo.data';
      var REMOTE_PACKAGE_BASE = 'BarycentricCoordinateDemo.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_Applications/BarycentricCoordinates/BarycentricCoordinateDemo.data');

      };
      Module['addRunDependency']('datafile_Applications/BarycentricCoordinates/BarycentricCoordinateDemo.data');
...
var wasmBinaryFile = 'BarycentricCoordinateDemo.wasm';
