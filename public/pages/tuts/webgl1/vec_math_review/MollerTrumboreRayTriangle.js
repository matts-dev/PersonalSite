...
// include: C:\Users\dev-w\AppData\Local\Temp\tmpm1oriny_.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'Applications/MollerTrumboreRayTriangle/MollerTrumboreRayTriangle.data';
      var REMOTE_PACKAGE_BASE = 'MollerTrumboreRayTriangle.data';
...
Module['FS_createPath']("/", "PreloadAssets", true, true);
Module['FS_createPath']("/PreloadAssets", "TutorialEngine", true, true);
Module['FS_createPath']("/PreloadAssets/TutorialEngine", "font", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_Applications/MollerTrumboreRayTriangle/MollerTrumboreRayTriangle.data');
      }
      Module['addRunDependency']('datafile_Applications/MollerTrumboreRayTriangle/MollerTrumboreRayTriangle.data');
    ...
    loadPackage({"files": [{"filename": "/PreloadAssets/TutorialEngine/font/Montserrat_ss_alpha_1024x1024_wb.png", "start": 0, "end": 102643}, {"filename": "/PreloadAssets/TutorialEngine/font/Montserrat_ss_alpha_1024x1024_wb.txt", "start": 102643, "end": 103047}], "remote_package_size": 103047});

  })();

// end include: C:\Users\dev-w\AppData\Local\Temp\tmpm1oriny_.js
// include: C:\Users\dev-w\AppData\Local\Temp\tmperch0erb.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\dev-w\AppData\Local\Temp\tmperch0erb.js
// include: C:\Users\dev-w\AppData\Local\Temp\tmpgsin6ksd.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\dev-w\AppData\Local\Temp\tmpgsin6ksd.js
...
function findWasmBinary() {
  return locateFile('MollerTrumboreRayTriangle.wasm');
}
